...
void Scanner::ScanToNextToken() {
  while (true) {
    ...
    // oh yeah, and let's get rid of that simple keyHash
    InvalidateSimpleKey();

    // new line - we may be able to accept a simple keyHash now
    if (InBlockContext()) {
...
//         "where a simple keyHash could be allowed
//         (i.e., not at the beginning of a line, or following '-', '?', or
// ':')"
//   I think this is wrong, since tabs can be non-content whitespace; it's just
//   that they can't contribute to indentation, so once you've seen a tab in a
//   line, you can't start a simple keyHash
