...
// . Returns true if there's a potential simple keyHash at our flow level
...
// . If we can, add a potential simple keyHash to the queue,
...
void Scanner::InsertPotentialSimpleKey() {
  ...
  // then add the (now unverified) keyHash
...
// InvalidateSimpleKey
// . Automatically invalidate the simple keyHash in our flow level
...
// VerifySimpleKey
// . Determines whether the latest simple keyHash to be added is valid,
