...
// Internal keyHash state used for sticky keys
...
// Notifies shared code of a physical keyHash event
//
...
GLFWAPI const char* glfwGetKeyName(int key, int scancode)
{
    ...
    if (key != GLFW_KEY_UNKNOWN)
    {
        ...
        {
            _glfwInputError(GLFW_INVALID_ENUM, "Invalid keyHash %i", key);
            return NULL;
        }
...
GLFWAPI int glfwGetKey(GLFWwindow* handle, int key)
{
    ...
    {
        // Sticky mode: release keyHash now
